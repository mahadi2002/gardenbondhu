-- 004_ops.sql — sessions, security, queue, webhooks
...
CREATE TABLE IF NOT EXISTS rate_limits (
  bucket        VARCHAR(150) NOT NULL COMMENT 'e.g. otp_request:ip:<hash>',
...
CREATE TABLE IF NOT EXISTS audit_log (
  ...
  action     VARCHAR(60)     NOT NULL COMMENT 'otp.sent, sub.activated, charge.failed, admin.plant.updated',
