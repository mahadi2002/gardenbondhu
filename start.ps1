...
# GardenBondhu's own PHP dev server. Run it, then open the URL it prints —
# nothing to babysit.
#
# Usage:  powershell -ExecutionPolicy Bypass -File F:\Projects\gardenbondhu\start.ps1
