...
<form method="get" action="/admin/guides" class="cluster mb-1-5">
  <input class="input max-w-2xs" type="search" name="q" value="<?= e($query) ?>" placeholder="শিরোনাম বা slug খুঁজুন">
